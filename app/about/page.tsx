      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-20">
          ...
          <p className="text-xl text-text-secondary leading-relaxed mb-6">
            At ARK Technologies, our mission is to transform enterprise operations through the strategic deployment of artificial intelligence, ensuring seamless integration with existing systems to automate workflows, refine data processes, and enable accelerated, data-driven decision-making.
          </p>
          <p className="text-xl text-text-secondary leading-relaxed">
            We deliver tailored AI solutions that drive operational excellence and sustainable competitive advantage for leading industries, including Real Estate, Manufacturing and Distribution, Wealth Management, Healthcare, and Automation. By prioritizing precision, scalability, and alignment with business objectives, we empower organizations to optimize efficiency, foster innovation, and achieve long-term growth in dynamic markets.
          </p>
        </div>
      </section>
